...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div className='flex flex-col h-full'>
        ...
        <div className='p-4 pb-[27px] border-b border-pink-200 flex justify-between items-center'>
          ...
          <button
            className='lg:hidden p-1 text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer'
          ...
          matches.length === 0 ? <NoMatchesFound /> : (
            matches.map((match) => (
              <Link key={match._id} to={`/chat/${match._id}`}>
                <div className='flex items-center mb-4 cursor-pointer hover:bg-gradient-to-r from-orange-100 via-orange-50 to-pink-100 p-2 rounded-lg
                transition-colors duration-300'>
                  <img src={match.image || "/avatar.png"} alt="Match Image" 
    ...
    <button className='lg:hidden fixed top-4 left-4 p-2 bg-orange-300 text-white rounded-md z-0 cursor-pointer' 
      onClick={toggleSidebar}
    >
...
const NoMatchesFound = () => (
  <div className='flex flex-col items-center justify-center h-full text-center'>
    <Heart className='text-orange-300 mb-4' size={48} />
...
const LoadingState = () => (
  <div className='flex flex-col items-center justify-center h-full text-center'>
    <Loader className='text-orange-300 mb-4 animate-spin' size={48} />
